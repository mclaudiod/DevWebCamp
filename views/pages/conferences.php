<main class="schedule">
    <h2 class="schedule__heading">Workshops and Conferences</h2>
    <p class="schedule__description">Workshops and conferences dictated by experts in web development</p>

    <div class="events">
        <h3 class="events__heading">&lt;Conferences/></h3>
        <p class="events__date">Friday October 6th</p>
        ...
        <p class="events__date">Saturday October 7th</p>
